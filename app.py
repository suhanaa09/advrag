...
# CSS: nuke any Streamlit uploader that might appear, hide helper inputs
st.markdown("""
<style>
[data-testid="stFileUploader"] { display: none !important; }
.main .block-container { padding-bottom: 90px !important; }
/* Hide helper text inputs — target by label text */
div[data-testid="stTextInput"]:has(label:empty),
div[data-testid="stTextInput"] label { font-size: 0 !important; height: 0 !important; }
</style>
""", unsafe_allow_html=True)

# Hidden text_input 1: voice transcript
voice_text = st.text_input("v", key="voice_input_field", label_visibility="collapsed")
...
# Hidden text_input 2: file JSON payload
file_payload_raw = st.text_input("f", key="file_payload_field", label_visibility="collapsed")
